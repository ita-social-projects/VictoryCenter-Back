    ...
    where TStartup : class
{
    ...
    static private void SetEnvironmentalVariables()
    {
        ...
        Environment.SetEnvironmentVariable("DB_CONNECTION_STRING", "Server=localhost,1434;Database=VictoryCenter_IntegrationTests_Db;MultipleActiveResultSets=True;TrustServerCertificate=true");
