...
public class UpdateHippotherapyProgramTests
{
    ...
    public async Task Handle_ShouldUpdateProgram_WhenImagesAreNull()
    {
        ...
        _programEntity.Status = Status.Draft;
        ...
        _programEntity.Categories = [];

        SetUpAutomapper();

        _repositoryWrapperMock.Setup(r => r.HippotherapyProgramsRepository
                .GetFirstOrDefaultAsync(It.IsAny<QueryOptions<HippotherapyProgram>>()))
        ...
        var handler = new UpdateHippotherapyProgramHandler(
            _mapperMock.Object,
        ...
        Result<HippotherapyProgramDto> result =
            await handler.Handle(new UpdateHippotherapyProgramCommand(_updateProgramDto, 1), CancellationToken.None);
    ...
    public async Task Handle_ShouldFailUpdate_WhenSomeCategoriesDoNotExist()
    {
        ...
        var result = await handler.Handle(
            new UpdateHippotherapyProgramCommand(_updateProgramDto, 1),
