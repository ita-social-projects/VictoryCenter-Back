...
public class GetPublicHippotherapyLandingPageHandlerTests
{
    ...
    public async Task Handle_WhenPageExists_ShouldReturnMappedDto()
    {
        ...
        var handler = new GetPublicHippotherapyLandingPageHandler(_repositoryWrapperMock.Object, _mapperMock.Object);

        // Act
        var result = await handler.Handle(new GetPublicHippotherapyLandingPageQuery(), CancellationToken.None);
