...
public class GetAllUahBankDetailsTests
{
    ...
    public GetAllUahBankDetailsTests()
    {
    ...
    {
        SetupDependencies();
        var handler = new GetAllUahBankDetailsHandler(_mockMapper.Object, _mockRepositoryWrapper.Object);

        Result<List<UahBankDetailsDto>> result = await handler.Handle(new GetAllUahBankDetailsQuery(), CancellationToken.None);
