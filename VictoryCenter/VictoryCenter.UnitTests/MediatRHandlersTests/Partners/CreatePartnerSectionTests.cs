...
public class CreatePartnersSectionTests
{
    ...
    private readonly Mock<IValidator<CreatePartnersSectionCommand>> _mockValidator;
    ...
    private readonly PartnersSectionDto _resultDto = new()
    {
        ...
        Partners =
        [
            new() { Description = "Partner 1" },
            new() { Description = "Partner 2" }
        ]
    };
    ...
    public CreatePartnersSectionTests()
    {
        ...
        _mockValidator = new Mock<IValidator<CreatePartnersSectionCommand>>();
    ...
    public async Task Handle_ValidRequest_ShouldCreateSectionAndReturnOk()
    {
        ...
        var handler = new CreatePartnersSectionHandler(_mockRepositoryWrapper.Object, _mockMapper.Object, _mockValidator.Object, _mockReorderService.Object);
    ...
    public async Task Handle_NonExistingImageId_ShouldReturnFailure()
    {
        ...
        // Override the image repository setup to simulate a missing image
    ...
    private void SetupValidator(bool isValid, string errorMessage = "Error")
    {
        var validationResult = isValid
            ...
            : new ValidationResult(new[] { new ValidationFailure("Property", errorMessage) });

        _mockValidator
            .Setup(v => v.ValidateAsync(It.IsAny<CreatePartnersSectionCommand>(), It.IsAny<CancellationToken>()))
    ...
    {
        _mockReorderService.Setup(s => s.GetNextDisplayOrderAsync<PartnerSection>(
    ...
    private void SetupRepositoryWrapper(PartnerSection createdEntity)
    {
        ...
        // Setup the return of the created entity for the final query
