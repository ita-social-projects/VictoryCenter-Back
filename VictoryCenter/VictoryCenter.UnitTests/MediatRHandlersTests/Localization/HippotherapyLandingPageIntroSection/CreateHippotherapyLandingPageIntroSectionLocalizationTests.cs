...
public class CreateHippotherapyLandingPageIntroSectionLocalizationTests
{
    ...
    private readonly CreateHippotherapyLandingPageIntroSectionLocalizationHandler _handler;

    private readonly CreateHippotherapyLandingPageIntroSectionLocalizationDto _createDto = new()
    {
        EntityId = 1,
        LanguageId = 2,
        Title = "Hippotherapy",
    ...
    public CreateHippotherapyLandingPageIntroSectionLocalizationTests()
    {
        ...
        _validator = new CreateHippotherapyLandingPageIntroSectionLocalizationValidator(
            new BaseHippotherapyLandingPageIntroSectionLocalizationValidator());
        _handler = new CreateHippotherapyLandingPageIntroSectionLocalizationHandler(
    ...
    public async Task Handle_ShouldCreateLocalization_Successfully()
    {
        ...
        var result = await _handler.Handle(
            new CreateHippotherapyLandingPageIntroSectionLocalizationCommand(_createDto),
    ...
    {
        var invalidDto = new CreateHippotherapyLandingPageIntroSectionLocalizationDto
        {
            EntityId = 0,
            LanguageId = 0,
            Title = "",
        ...
        var result = await _handler.Handle(
            new CreateHippotherapyLandingPageIntroSectionLocalizationCommand(invalidDto),
            CancellationToken.None);
    ...
    {
        _mockMapper.Setup(m => m.Map<HippotherapyLandingPageIntroSectionLocalization>(_createDto)).Returns(_entity);
