...
public class GetWhoWeAreContentLocalizationByEntityIdHandler : IRequestHandler<GetWhoWeAreContentLocalizationByEntityIdQuery, Result<List<WhoWeAreContentLocalizationDto>>>
{
    private readonly IMapper _mapper;
    private readonly IRepositoryWrapper _repository;

    public GetWhoWeAreContentLocalizationByEntityIdHandler(IMapper mapper, IRepositoryWrapper repository)
    {
        _mapper = mapper;
        _repository = repository;
    }

    public async Task<Result<List<WhoWeAreContentLocalizationDto>>> Handle(GetWhoWeAreContentLocalizationByEntityIdQuery request, CancellationToken cancellationToken)
    {
