...
public class CreateCorrespondentBankDetailsHandler : IRequestHandler<CreateCorrespondentBankDetailsCommand, Result<CorrespondentBankDetailsDto>>
{
    ...
    public async Task<Result<CorrespondentBankDetailsDto>> Handle(CreateCorrespondentBankDetailsCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            return Result.Fail<CorrespondentBankDetailsDto>(ErrorMessagesConstants.FailedToCreateEntity(typeof(Entities.CorrespondentBankDetails)));
        }
