...
public class UpdateHippotherapyLandingPageAnalysisSectionLocalizationHandler
    : IRequestHandler<UpdateHippotherapyLandingPageAnalysisSectionLocalizationCommand, Result<HippotherapyLandingPageAnalysisSectionLocalizationDto>>
{
    ...
    public UpdateHippotherapyLandingPageAnalysisSectionLocalizationHandler(
        IMapper mapper,
        ...
        IValidator<UpdateHippotherapyLandingPageAnalysisSectionLocalizationCommand> validator)
    {
        _mapper = mapper;
    ...
    public async Task<Result<HippotherapyLandingPageAnalysisSectionLocalizationDto>> Handle(
        UpdateHippotherapyLandingPageAnalysisSectionLocalizationCommand request,
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var entity = _mapper.Map<HippotherapyLandingPageAnalysisSectionLocalization>(
                request.UpdateHippotherapyLandingPageAnalysisSectionLocalizationDto);
