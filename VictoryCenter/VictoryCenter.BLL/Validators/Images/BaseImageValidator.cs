...
public class BaseImageValidator : AbstractValidator<ImageDTO>
{
    ...
    public BaseImageValidator()
    {
        RuleFor(x => x.BlobName)
            .NotEmpty().WithMessage("BlobName is required")
            .MaximumLength(255).WithMessage("BlobName cannot exceed 255 characters");
