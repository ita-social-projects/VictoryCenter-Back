...
public class UpdateCorrespondentBankDetailsDtoValidator : AbstractValidator<UpdateCorrespondentBankDetailsDto>
{
    public UpdateCorrespondentBankDetailsDtoValidator()
    {
        ...
        RuleFor(dto => dto.Iban)
            .NotEmpty()
            .WithMessage(ErrorMessagesConstants.PropertyIsRequired(nameof(CorrespondentBankDetailsDto.Iban)))
