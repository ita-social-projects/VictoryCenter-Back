...
public class CreateCorrespondentBankDetailsDtoValidator : AbstractValidator<CreateCorrespondentBankDetailsDto>
{
    public CreateCorrespondentBankDetailsDtoValidator()
    {
